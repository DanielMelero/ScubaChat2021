    ...
    public MyProtocol(String server_ip, int server_port, int frequency){
        ...
        try{
            ...
            while(true){
                ...
                if(read > 0){
                    ByteBuffer toSend = ByteBuffer.allocate(read-2); // java includes newlines in System.in.read, so -2 to ignore this
                    toSend.put( temp.array(), 0, read-2 ); // java includes newlines in System.in.read, so -2 to ignore this
                    Message msg;
                    if( (read-2) > 2 ){
